...
/**
 * Checks whether a given balance of WLI, represented as a hex string, is sufficient to pay a value plus a gas fee
 *
 ...
 * @param {string} txParams.value The value of WLI to send
 * @param {string} hexBalance - A balance of WLI represented as a hex string
