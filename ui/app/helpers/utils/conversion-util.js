...
* @param {string} [options.fromCurrency = 'WLI' | 'USD'] The currency of the passed value
* @param {string} [options.toCurrency = 'WLI' | 'USD'] The desired currency of the result
 ...
 * @typedef {('WEI' | 'GWEI' | 'WLI')} EthDenomination
 */
